...
# Verify the convergence table 
RUN_CALCULATE_AREA_D      = TRUE
VERIFY_CALCULATE_AREA_D   = TRUE
...
if(RUN_VERIFY_CONVERGE_IMG & TRUE)
{
  lambda       <- 0.2
  sampleSize   <- 40
  mu           <- 1/lambda
...
calcAreaDelta <- function(sampleRepetition, simData)
{
  if((RUN_CALCULATE_AREA_D & VERIFY_CALCULATE_AREA_D) | TRUE)
  {
    print("generateSimData: verify inputs")
    print(paste0("sampleRepetitions = ", sampleRepetition))
    # print("simData = ")
...
if(RUN_CALCULATE_AREA_D)
{


  calcAreaDelta(sampleRepetition, simData)
}
